...
./validate-anchor-compas.py -e smt -s z3 -c -v temp/propublica_fairml_data/propublica_fairml_data_nbestim_50_maxdepth_3_testsplit_0.2.mod.pkl > compas-validated.anchor
...
./validate-lime-compas.py -e smt -s z3 -c -v temp/propublica_fairml_data/propublica_fairml_data_nbestim_50_maxdepth_3_testsplit_0.2.mod.pkl > compas-validated.lime
